/**
 * Modified by Leo Zhang, use List Serializer method to marshall Set
 */
...
public class SetSerializer extends AbstractSerializer
{
      ...
      throws MarshallException
  {
    ...
    try
    {
      while (i.hasNext())
      {
          Object json = ser.marshall(state, setdata, i.next(), new Integer(index));
